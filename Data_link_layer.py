...
def Data_link_layer(data3, sourceDevice):
    ...
    if c3 == 1:
        ...
        # Determine which hub is transferring the data and which hub is receiving the data
        transfer_hub = hub1 if sourceDevice in ["A", "B", "C"] else hub2
        # sending hub is the receiving hub
        receiving_hub = hub1 if transfer_hub == hub2 else hub2
        ...
        print("Receiving Hub:", receiving_hub.name)
